...
function SmartDashboard() {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center gap-4 bg-gandehou-paper px-6 text-center dark:bg-neutral-950 dark:text-white">
      <p className="text-lg font-semibold">Compte en attente de configuration</p>
      <p className="max-w-sm text-sm text-neutral-900/60 dark:text-white/60">
        Votre compte est connecté mais n'a pas encore de rôle assigné.
