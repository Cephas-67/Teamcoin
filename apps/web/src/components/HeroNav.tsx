            ...
            <div className="fixed left-0 top-0 z-40 flex w-full items-center justify-between p-4 sm:p-6 md:p-10 backdrop-blur-lg md:backdrop-blur-none">
                ...
                <div className="ml-auto flex items-center gap-3 sm:gap-6 md:ml-3">
                    ...
                    <button
                        ...
                        className="p-3 bg-black/30 sm:hidden dark:bg-white dark:text-black dark:hover:bg-white/30 dark:hover:text-white hover:bg-black/60 text-white transition-colors duration-500 text-lg rounded-full flex felx-row items-center gap-3"
                    >
